...
var LoaderManager = (function () {
    ...
    LoaderManager.getUrl = function (url) {
        if (LoaderManager.HEADURL != "") {
    ...
    LoaderManager.prototype.checkLoad = function () {
        if (this.idleLoaders.length > 0 && this.queue.length > 0) {
            ...
            if (true) {
                ...
                var request = new egret.URLRequest(LoaderManager.HEADURL + ctx.url);
                loader.load(request);
            }
        }
    };
    ...
    LoaderManager.HEADURL = "";
    LoaderManager.ZIPHEADURL = "";
