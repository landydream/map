...
var AIMovePlug = (function () {
    ...
    AIMovePlug.prototype.setBron = function () {
    ...
    AIMovePlug.prototype.update = function (ctx) {
        var self = this;
        self.remain -= ctx.dt;
    ...
    AIMovePlug.prototype.getNextPoint = function () {
    ...
    AIMovePlug.prototype.startMove = function () {
        var mapMgr = GameGlobal.mapscene.mapMgr;
        var p = this.getNextPoint();
        if (p != null) {
    ...
    AIMovePlug.prototype.onEvent = function (evt, arg) {
    };
    return AIMovePlug;
}());
__reflect(AIMovePlug.prototype, "AIMovePlug");
//# sourceMappingURL=AIMovePlug.js.map